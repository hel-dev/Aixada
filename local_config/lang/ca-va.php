...
$Text['btn_ok'] = "Entesos: distribueix i valida!";
$Text['btn_continue_reviewing'] = "Encara no: vull seguir revisant";
...
$Text['msg_err_unrevised'] = "Encara hi ha element pendents de revisar a la comanda. Si us plau, verifica que hagin arribat tots els productes!<br/><br/><strong>ATENCIÓ!!! No validis fins que el total no coincideixi amb el total de l'albarà!!:</strong><br/>• Si no tens l'albarà, NO VALIDIS!!<br/>• Si l'albarà està equivocat, NO VALIDIS!!<br/><br/><strong style='color: #721c24; font-size: 16px;'>Aquest pas és irreversible!!!</strong>";
...
$Text['tit_set_shpDate'] = "Confirmació";
$Text['msg_cur_status'] = "L'estat de la comanda és";
$Text['msg_change_status'] = "Canvia l'estat a";
$Text['msg_confirm_move'] = "Verifica que hagin arribat tots els productes abans de validar la comanda!";
$Text['msg_pending_items'] = "Encara hi ha element pendents de revisar a la comanda. Si us plau, verifica que hagin arribat tots els productes!";
$Text['msg_attention_warning'] = "ATENCIÓ!!! No validis fins que el total no coincideixi amb el total de l'albarà!!:";
$Text['msg_no_delivery_note'] = "Si no tens l'albarà, NO VALIDIS!!";
$Text['msg_wrong_delivery_note'] = "Si l'albarà està equivocat, NO VALIDIS!!";
$Text['msg_irreversible'] = "Aquest pas és irreversible!!!";
